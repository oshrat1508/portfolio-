...
export default function Home() {
  ...
  return (
   ...
   <div className="md:h-[55%] md:w-72 w-48 h-[40%]  border-4 border-fuchsia-800 md:right-52 right-20 top-[410px] md:top-28 rounded-md absolute "></div>
   <div className="md:h-[55%] md:w-72 w-48 h-[40%]  border-4 border-[#673964] md:right-40 right-10 top-[350px] md:top-40 rounded-md absolute"></div>
