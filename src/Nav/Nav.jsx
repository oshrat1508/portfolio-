...
export default function HeaderNav() {
  ...
  return (
    <div className="flex  justify-between items-center w-full fixed h-20  z-20 ">



      <ul className=" flex md:flex-col justify-center items-center fixed md:top-0 md:left-0 w-full p-1 md:h-screen  md:w-32  ">
