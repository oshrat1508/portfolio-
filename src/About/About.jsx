...
export default function About() {
  ...
  return (
    <section id='about' className=' md:h-[60vh] flex flex-col md:flex-row md:ml-36 mb-16 md:mb-0 justify-center mt-10 md:mt-9 '>
      ...
      <div className='  flex  text-lg items-center'> Graduate from the Full Stack course at Tech Career, Technology Training center December 2022
...
Quick self learner, highly motivated to succeed.</div></div>
   ...
   <section className=' md:w-[50%] w-[100%] mt-10 flex flex-col items-center'>
      ...
      <form method='POST' action='https://getform.io/f/8d5237a8-d5c8-40b9-82e5-2d2162cbeba5' className=' flex flex-col w-4/5'>
      <input name='name' className=' border-b-2 rounded-t-md outline-none p-1 border-purple-800 ' type="text" placeholder='Enter Your Name' />
      <input name='email' className=' border-b-2 rounded-t-md outline-none p-1 border-purple-800 my-5 ' type="email" placeholder='Enter Your Email' />
      <textarea name='massege' className=' border-b-2 rounded-t-md outline-none p-1 border-purple-800 h-20 mb-3' type="text"  placeholder='Enter Your massege' />
      
      <button type="submit"  className='p-2 bg-slate-400 rounded mt-2  '>send</button>
      </form>
    </section>   
</section>
  )
